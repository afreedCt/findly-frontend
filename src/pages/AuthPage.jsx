...
//   return (
//     <div
//       className={`${isLogin?"active":""} d-flex justify-content-center align-items-center min-vh-100 auth-wrapper`}
//       style={{ minHeight: "100vh" }}
//     >
//       {isLogin ? (
//         <div
//           className={`login shadow-lg row mx-auto`}
...
//               <button className="btn btn-outline-primary w-100 rounded-3 my-3">
//                 Login
//               </button>
//             </form>

//             <div
//               className="google w-100 bg-white shadow-lg px-2 py-3 d-flex justify-content-center align-items-center gap-2"
//               style={{ cursor: "pointer" }}
//             >
//               <i className="fa-brands fa-google "></i>
//               <span className="fw-bold tracking-widest">
//                 Signin with google
//               </span>
//             </div>
//           </div>
//           <div
//             className="left col-md-6 bg-info d-flex flex-column justify-content-center align-items-center text-white"
//             style={{
...
//           >
//             <h1>Hello Friend !</h1>
//             <h4 className=" p-3">Don't have an Account ...</h4>
//             <Link
...
//       ) : (
//         <div
//           className="register shadow-lg row mx-auto"
//           style={{ width: "750px", height: "450px" }}
//         >
//           <div
//             className={`left col-md-6 bg-info d-flex flex-column justify-content-center align-items-center text-white`}
...
//           </div>
//           <div className="col-md-6 bg- right p-3 ">
//             <h1 className="fw-bold text-primary text-center fs-1 mb-3">
